...
var koa_easy_ws_1 = __importDefault(require("koa-easy-ws"));
...
app.use(function (ctx, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, ctx.ws()];
            case 1:
                ws = _a.sent();
                documentName = ctx.request.path.substring(1);
                server.handleConnection(ws, ctx.request, documentName, 
